...
//Linha 41 a 80 - Tiago
        switch(opcao) {
            ...
            case 5:
                ...
                break;
            default:
                printf("Erro, tente novamente com uma op��o v�lida.\n");
        }
    } while(opcao != 5);
...
void addCliente() {
    ...
    if (scanf("%d", &cliente.codCliente) != 1) {
        printf("Erro ao inserir o c�digo do cliente.\n");
        fclose(arquivo);
        while (getchar() != '\n');
        return;
    }
...
void visuCliente() {
    ...
    printf("C�digo | Nome | Telefone | Endere�o | Estado | CPF | RG\n");
...
void delCliente() {
    int codigo;
    printf("\nDigite o c�digo do cliente a ser deletado: ");
    if (scanf("%d", &codigo) != 1) {
...
void updateCliente() {
    int codigo;
    printf("\nDigite o c�digo do cliente a ser atualizado: ");
    if (scanf("%d", &codigo) != 1) {
        printf("C�digo inv�lido.\n");
        while (getchar() != '\n');
        return;
